class PrivateChatsController < ApplicationController
  ...
  def show
    @conversation = Message.where(sender_id: params[:sender_id], recipient_id: params[:recipient_id]).or(Message.where(sender_id: params[:recipient_id], recipient_id: params[:sender_id])).sort_by {|mes| mes[:id]}
  ...
  def all_current_user_chats
    ...
    @all_users_chats = Message.where(sender_id: params[:id]).or(Message.where(recipient_id: params[:id])).order(created_at: :desc)
